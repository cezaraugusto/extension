...
import RunSafariPlugin from './steps/RunSafariPlugin'

export default class RunSafariExtension {
  ...
  /**
   * RunSafariExtension works by creating a WebSockets server
  ...
  apply(compiler: webpack.Compiler) {
    ...
    // for everything else, for now opening the safari://extension page on startup.
    // It starts a new browser instance with the user extension loaded.
    new RunSafariPlugin(this.options).apply(compiler)
  }
}
